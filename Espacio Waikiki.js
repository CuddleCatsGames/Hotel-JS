	...
	roomsArr: [
		...
		},
		{
			...
			roomAmenitiesArr: [
				{
					name: 'Accesibility', // string
					url: 'https://www.espaciowaikiki.com/luxury-suites/luxury-suite-three-bedroom-accessible/#accessibility', // url
					imageUrl: '' // url
				}
				{
					name: 'Exclusive car service within Waikiki', // string
